...
export const KIA_CONCEPTS: ConceptCard[] = [
  {
    ...
    question:
      "In the King's Indian Attack, what is White's main strategic plan once the setup is complete?",
    position: {
    ...
    correctAnswer:
      "Launch a kingside attack with pawn advances (f4, g4, h4) supported by pieces, targeting the opponent's castled king.",
    hints: [
    ...
    explanation:
      "The KIA is fundamentally a kingside attacking system. Once development is complete, White launches a pawn storm on the kingside (f4-f5, g4-g5, h4-h5) to open lines and create threats against Black's king. The g2 bishop, f3 knight, and queen coordinate to exploit the weaknesses created by the pawn advances.",
  ...
  },
  {
    ...
    question:
      "Why is the move e4 so critical in the King's Indian Attack, and when is the right time to play it?",
    position: {
    ...
    correctAnswer:
      'The move e4 establishes a strong central pawn duo (d3+e4), gains space, and opens the long diagonal for the g2 bishop. It should be played after completing development (Nf3, g3, Bg2, O-O, Nbd2).',
    hints: [
    ...
    explanation:
      "The e4 advance is the thematic central break in the KIA. It gives White a space advantage, controls the d5 and f5 squares, and activates the g2 bishop's diagonal. Playing it after full development (especially after castling and Nbd2) ensures White is ready to handle the resulting central tension.",
    relatedOpeningLine: 'kia-main-1',
  },
  {
    id: 'kia-concept-3',
    ...
    question:
      'Why is the King\'s Indian Attack considered a "universal" opening system, and how does move order flexibility benefit White?',
    position: {
    ...
    correctAnswer:
      "The KIA is universal because White can reach the same setup (Nf3, g3, Bg2, d3, O-O, e4, Nbd2) regardless of Black's moves. The flexible move order prevents Black from dictating the opening and allows White to transpose into favorable positions.",
    hints: [
...
export const STONEWALL_CONCEPTS: ConceptCard[] = [
  {
    ...
    question:
      'In the Stonewall formation, why is White\'s light-squared bishop considered "bad," and how should White handle this piece?',
    position: {
    ...
    correctAnswer:
      'The light-squared bishop is "bad" because White\'s pawns on d4, e3, and f4 are all on light squares, blocking the bishop. White should either develop it actively to d3 before completing the pawn chain, or trade it off for Black\'s pieces.',
    hints: [
  ...
  },
  {
    ...
    question:
      'How does White create attacking chances in the Stonewall Attack despite having a passive light-squared bishop?',
    position: {
    ...
    correctAnswer:
      "White launches a kingside pawn storm with moves like g4-g5, h4-h5, creating threats and opening lines for the major pieces to attack Black's king.",
    hints: [
    ...
    explanation:
      "Despite the structural weakness of the bad bishop, the Stonewall Attack is dynamic because White can launch a direct kingside assault. The moves g4-g5 and h4-h5 create threats, and when pawns are exchanged, files open for White's rooks and queen to penetrate toward Black's king.",
    relatedOpeningLine: 'stonewall-main-1',
  },
  {
    ...
    question:
      'In certain Stonewall positions, White can play e4-e5. What does this pawn break accomplish, and when is it appropriate?',
    position: {
    ...
    correctAnswer:
      "The e4-e5 break attacks Black's Nf6, gains space, opens lines for White's pieces, and transforms the position from static to dynamic. It's appropriate when White's pieces are well-placed to support the attack and Black's pieces are not ready to counter.",
    hints: [
    ...
    explanation:
      "While the Stonewall is typically a slow, positional system, the e4-e5 break can transform it into a sharp attacking position. This advance attacks the Nf6, opens the f-file for the rook, activates the Bd3, and gives White concrete threats. However, timing is critical - play it too early and Black can counter-attack effectively. The e5 break works best when White has castled, connected the rooks, and Black's pieces are poorly coordinated.",
    relatedOpeningLine: 'stonewall-main-1',
  },
];
...
export const COLLE_CONCEPTS: ConceptCard[] = [
  {
    ...
    question:
      'What is the purpose of the thematic e4 pawn break in the Colle System, and what conditions must be met before playing it?',
    position: {
    ...
    correctAnswer:
      "The e4 break opens the position, activates White's pieces (especially the Bd3 and Qd1-h5 battery), and creates central tension. It should be played after Nbd2, when the e4 pawn is supported and White is ready to recapture with the knight.",
    hints: [
    ...
    explanation:
      "The Colle System builds slowly with d4, Nf3, e3, Bd3, but the key moment is e3-e4! This pawn break transforms the position by opening lines and activating White's pieces. The Nbd2 is crucial because after ...dxe4 Nxe4, White has a strong central knight. The Bd3 and queen can then combine for kingside threats.",
  ...
  },
  {
    ...
    question:
      'In the Colle System, how does the knight reach the powerful e5 square, and why is this square so important?',
    position: {
...
export const LONDON_CONCEPTS: ConceptCard[] = [
  {
    ...
    question:
      'Why is the move Bf4 played so early in the London System (often on move 2), and what does this accomplish?',
    position: {
    ...
    correctAnswer:
      'Bf4 is played before e3 to avoid "imprisoning" the bishop behind the e3 pawn. This move develops the bishop to an active square, controls e5, and prepares a solid pawn structure with e3, Nf3, and Bd3.',
    hints: [
  ...
  },
  {
    ...
    question:
      'In the London System, when should White play h3 and g4, and what is the strategic purpose of this pawn advance?',
    position: {
    ...
    correctAnswer:
      "The h3-g4-g5 plan is played when White wants to launch a kingside attack, gain space, and chase away Black's Nf6. It should be played after completing development and when the center is stable.",
    hints: [
    ...
    explanation:
      "The h3 and g4 plan is a key attacking idea in the London. After solid development, White plays h3 (preventing ...Ng4), then g4-g5, forcing Black's knight to retreat. This gains space, opens lines, and gives White attacking chances. However, it weakens the kingside, so White must castle first and ensure the center is secure before launching this plan.",
    relatedOpeningLine: 'london-main-1',
  },
  {
    id: 'london-concept-3',
    ...
    question:
      "How does the London System's pawn structure (d4, e3, c3) provide both solid defense and flexibility?",
    position: {
    ...
    correctAnswer:
      "The d4-e3-c3 pawn triangle controls key central squares, provides a solid base for pieces, prevents Black's pieces from infiltrating (especially on b4 and e4), and prepares potential pawn breaks like e4 or c4.",
    hints: [
...
export const TORRE_CONCEPTS: ConceptCard[] = [
  {
    ...
    question:
      'What is the purpose of the famous Bg5-h4-g3 bishop maneuver in the Torre Attack, and when should it be played?',
    position: {
    ...
    correctAnswer:
      "The Bg5-h4-g3 maneuver retreats the bishop when Black plays ...h6, repositioning it to g3 where it eyes the c7 pawn and supports a kingside attack. It's played after Black challenges the bishop with ...h6.",
    hints: [
  ...
  },
  {
    ...
    question:
      'In the Torre Attack, why is establishing a knight on e5 so important, and how does White achieve this?',
    position: {
    ...
    correctAnswer:
      'A knight on e5 is a powerful central outpost that controls key squares, supports attacks, and is difficult to remove. White achieves this by controlling e5 with pawns and pieces, then maneuvering a knight there via Nfd2-f3-e5.',
    hints: [
  ...
  },
  {
    ...
    question:
      'How does the Torre Attack balance piece activity (Bg5) with solid pawn structure (e3, d4)?',
    position: {
    ...
    correctAnswer:
      'The Torre uses e3 for solid central control while Bg5 provides active piece play. The e3-d4 structure is stable, supports the center, and prepares c2-c4 or e3-e4 breaks while the Bg5 creates immediate tactical threats.',
    hints: [
    ...
    explanation:
      'The Torre Attack balances solidity with activity. The e3-d4 pawn center is rock-solid, controls key squares, and prepares flexible pawn breaks (c4 or e4). Meanwhile, Bg5 creates immediate pressure by pinning the knight, threatening tactics, and forcing Black to respond. This combination of solid structure and active pieces makes the Torre both safe and aggressive.',
    relatedOpeningLine: 'torre-main-1',
  },
];
...
export const GENERAL_CONCEPTS: ConceptCard[] = [
  {
    ...
    correctAnswer:
      'A "good" bishop has its pawns on the opposite color, giving it mobility. A "bad" bishop is blocked by its own pawns on the same color. This matters in endgames because the bad bishop cannot defend its pawns or control key squares.',
    hints: [
  ...
  },
  {
    ...
    question:
      'What are the advantages and potential drawbacks of fianchettoing a bishop (developing it to g2 or b2)?',
    position: {
    ...
    correctAnswer:
      'Advantages: Controls the long diagonal, adds pressure to the center, provides flexible piece placement. Drawbacks: Weakens the kingside dark squares (h3, g2, f3), takes time (two moves), and the bishop can be blocked by central pawns.',
    hints: [
    ...
    explanation:
      "The fianchetto (g3/Bg2 or b3/Bb2) is powerful because the bishop exerts long-range pressure on key central squares and supports both attack and defense. However, it requires two moves, weakens squares around the king (like h3 and f3), and the bishop can become passive if Black blocks the diagonal with pawns. It's a trade-off between flexibility and speed.",
    relatedOpeningLine: 'kia-main-1',
  },
  {
    ...
    concept: 'Pawn Chains',
    question:
      'In a locked pawn chain (e.g., White pawns on d4-e5, Black pawns on e6-d5), where should each side typically attack?',
    position: {
    ...
    correctAnswer:
      "Each side should attack the base of the opponent's pawn chain. White should attack Black's e6 pawn (the base), while Black should attack White's d4 pawn (the base). The side of the board you attack on depends on where the pawn chain points.",
    hints: [
  ...
  },
  {
    ...
    question:
      'What makes a square an ideal "outpost" for a knight, and why are outposts so valuable?',
    position: {
    ...
    correctAnswer:
      "An ideal outpost is a square in the opponent's territory that cannot be attacked by enemy pawns, is defended by your pawns, and is centrally located. Outposts are valuable because pieces placed there control key squares, support attacks, and are difficult to remove.",
    hints: [
  ...
  },
  {
    ...
    question:
      'What does it mean to have a "space advantage" in chess, and how can you use it to your benefit?',
    position: {
    ...
    correctAnswer:
      "A space advantage means your pawns control more territory, giving your pieces more room to maneuver while restricting your opponent's pieces. You can use it by maneuvering pieces to better squares, preparing attacks, and making it hard for your opponent to develop.",
    hints: [
  ...
  },
  {
    ...
    question:
      'What does "piece coordination" mean, and how can you tell if your pieces are working together effectively?',
    position: {
    ...
    correctAnswer:
      'Piece coordination means your pieces support each other and work toward common goals (controlling key squares, attacking targets, defending weaknesses). Well-coordinated pieces attack the same targets, control overlapping squares, and defend each other.',
    hints: [
